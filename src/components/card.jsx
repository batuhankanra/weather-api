...
export default function Card({text,icon,time,heat,humidity}) {
    const hours=time.split(' ')[1];

  return (
    <div className=' cursor-default flex h-[150px] w-[150px] hover:scale-105 transition-all duration-300  items-center text-white bg-linear-to-t from-sky-500 to-indigo-500 p-2 rounded-md'>
